#!/bin/bash
# Set Variables
 templateDir=/Users/thomasganka/workspace/OpenCovid19Team/StreamSets/azure/deployments
 templateFile=$templateDir/vnetdeploy.json
...
az group export --name $resourceGroup > streamsetsResourceGroup.json

# Create a deployment from Streamsets template
az group deployment create \
    --resource-group $resourceGroup \
    --template-file streamsetsResourceGroup.json
